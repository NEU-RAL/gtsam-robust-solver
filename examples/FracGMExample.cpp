...
/**
 * @file FracGMExample.cpp
 * @brief Simple example showcasing a FracGM based solver
...
#include <gtsam/nonlinear/FracgmOptimizer.h>
...
int main() {
  cout << "Fractional Program with Geman-McClure Example\n";
  ...
  // Set FracGM-specific options
  FracgmParams<LevenbergMarquardtParams> fracgmParams(lmParams);

  // Optimize the graph and print results
  FracgmOptimizer<FracgmParams<LevenbergMarquardtParams>> optimizer(graph, initial, fracgmParams);
